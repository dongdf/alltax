<template>
  <div class="allSearch" >
    <div class="searchBox" @click="showsearchbox" >
      ...
      <div class="searchTextBox"><span>{{searchTips?searchTips:'请输入查找关键字'}}</span></div>
      <div class="cl"></div>
    </div>
    <div class="ppsearch" v-show="searchShow">
      <div class="ppsearchBox">
        <div class="searchBox">
          <div class="searchIcons"><img src="../pages/course/imgs/searchIcons.png"></div>
          <div class="searchTextBox"><input v-model="kwords" @keyup.enter="enterSearch()" ref="msearchinputbox" :placeholder="searchTips?searchTips:'请输入查找关键字'"/></div>
          <div class="cl"></div>
        </div>
  ...
  export default {
    ...
    methods:{
      ...
      enterSearch(){
        ...
        this.$router.push({path:'/search',query:{kw:this.kwords,ktype:this.ktype}})
      },
      hotSearch(obj){
        this.$router.push({path:'/search',query:{kw:obj.keywords,ktype:this.ktype}})
      },
    }
  }
</script>
