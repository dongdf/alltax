    ...
    <div id="agentinfodiv">
        <div id="expertinfo">
            <ul>
                ...
                <li class="clearfix">
                    <a href="javascript:void(0);">
					<span class="left">专家标签</span>
					<span class="right1">

					</span>
                        <div  class="clear">{{mineInfo.tags}}</div>
					</a>
                </li>
                <li class="sxian">
                    <img src="./img/xian.png">
                ...
                <li class="clearfix">
                    <a href="javascript:void(0);">
					<span class="left">所属级别</span>
					<span class="right1">
						{{ownArea.name1}}{{ownArea.name2}}{{ownArea.name3}} 专家
					</span>
					</a>
                </li>
                <li class="sxian">
                ...
                <li class="clearfix">
                    ...
                    <div style="padding-bottom:50px; padding-right:10px; color:#666;" v-html="mineInfo.introduction">
